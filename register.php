				...
				<div class="hpanel">
                    <div class="panel-body">
                        <form action="#" name="form1" method="post">
                            ...
                            <div class="alert alert-success" id="faliure" style="margin-top: 10px; display: none">
                                <strong>Already exists!</strong> This user is already registered
                            </div>
                        </form>
                    </div>
                </div>
    ...
    if(isset($_POST["submit1"])){
        ...
        if($count>0){
            ...
            <script type="text/javascript">
                ...
                document.getElementById("faliure").style.display="none";
            </script>
            <?php
        }
    }
